...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(screen.getByText('1619')).toBeTruthy();
      expect(screen.getByText('21.9k')).toBeTruthy();
      expect(screen.getByText('88')).toBeTruthy();
      const { getByText: getByTextFirstItem } = within(firstItem);
      expect(getByTextFirstItem('3')).toBeTruthy();
      ...
      const { getByText: getByTextSecondItem } = within(secondItem);
      expect(getByTextSecondItem('3')).toBeTruthy();
    });
  });
});
